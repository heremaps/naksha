...
NAKSHA_PVT_KEY_PATH="auth/jwt.key"
NAKSHA_PUB_KEY_PATHS="auth/jwt.pub"
...
java $JAVA_OPTS -jar /home/naksha/app/naksha-app-service-*.jar $NAKSHA_CONFIG_ID $NAKSHA_ADMIN_DB_URL