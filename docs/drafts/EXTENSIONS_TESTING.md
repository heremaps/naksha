...
Refer to the [EXT_MANAGER - Configuration Section](../drafts/EXT_MANAGER.md#configuration) for general config guidance.
...
Refer to the [`EXT_MANAGER` documentation](EXT_MANAGER.md#folder-structure) for full folder structure and content guidelines.
