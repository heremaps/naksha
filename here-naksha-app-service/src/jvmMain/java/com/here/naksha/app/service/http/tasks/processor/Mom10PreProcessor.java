...
/**
 * Pre Processor that populates pre MOM 10 namespaces from the feature if it's version is 10 or above.
 */
public final class Mom10PreProcessor implements FeaturePreProcessor<NakshaFeature> {

  public static final Mom10PreProcessor MOM_10_PRE_PROCESSOR = new Mom10PreProcessor();

  private Mom10PreProcessor() {
  }
