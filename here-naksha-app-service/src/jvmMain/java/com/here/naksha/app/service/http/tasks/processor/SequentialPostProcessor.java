...
public final class SequentialPostProcessor<T extends NakshaFeature> implements FeaturePostProcessor<T> {
  ...
  public static <T extends NakshaFeature> SequentialPostProcessor<T> combine(FeaturePostProcessor<T>... postProcessors) {
