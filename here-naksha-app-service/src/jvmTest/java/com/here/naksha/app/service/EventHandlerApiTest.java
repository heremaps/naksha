...
class EventHandlerApiTest extends ApiTest {
  ...
  void tc105_testCreateTagFilterHandler(String handlerProps, String expectedPropsInResponse)
      throws URISyntaxException, IOException, InterruptedException {
    final String streamId = UUID.randomUUID().toString();
    final String handlerId = "tag-filter-handler-create-" + Base64.getEncoder().encodeToString(handlerProps.getBytes());
    final String createJson = loadFileOrFail("EventHandlerApi/TC0105_createTagFilterHandler/create_event_handler_template.json").formatted(
        handlerId, handlerProps);
    final String expectedResponse = loadFileOrFail("EventHandlerApi/TC0105_createTagFilterHandler/response_template.json").formatted(
        handlerId, expectedPropsInResponse);
  ...
  void tc106_testCreateTagFilterHandlerValidationError(String handlerProperties, String errorMessage)
      throws URISyntaxException, IOException, InterruptedException {
    final String streamId = UUID.randomUUID().toString();
  ...
  @ParameterizedTest
  @MethodSource("validTagFilterProperties")
  void tc107_testUpdateTagFilterHandler(String handlerProps, String expectedPropsInResponse)
      throws URISyntaxException, IOException, InterruptedException {
    final String streamId = UUID.randomUUID().toString();
    final String handlerId = "tag-filter-handler-update-" + Base64.getEncoder().encodeToString(handlerProps.getBytes());
    final String createJson = loadFileOrFail("EventHandlerApi/TC0107_updateTagFilterHandler/create_event_handler_template.json").formatted(
        handlerId);
    final String updateJson = loadFileOrFail("EventHandlerApi/TC0107_updateTagFilterHandler/update_event_handler_template.json").formatted(
        handlerId, handlerProps);
  ...
  @ParameterizedTest
  @MethodSource("invalidTagFilterProperties")
  void tc108_testUpdateTagFilterHandlerValidationError(String handlerProperties, String errorMessage)
      throws URISyntaxException, IOException, InterruptedException {
    final String streamId = UUID.randomUUID().toString();
    final String handlerId = "tag-filter-handler-invalid-update-" + Base64.getEncoder().encodeToString(handlerProperties.getBytes());
    final String createJson = loadFileOrFail(
        "EventHandlerApi/TC0108_updateTagFilterHandlerValidationError/create_event_handler_template.json").formatted(handlerId);
    final String updateJson = loadFileOrFail(
        "EventHandlerApi/TC0108_updateTagFilterHandlerValidationError/update_event_handler_template.json").formatted(handlerId,
        handlerProperties);
    final String expectedResponse = loadFileOrFail(
        "EventHandlerApi/TC0108_updateTagFilterHandlerValidationError/response_template.json").formatted(errorMessage);
