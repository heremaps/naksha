...
public class ViewTypeUnionTest extends ApiTest {
    ...
    static void setup() throws URISyntaxException, IOException, InterruptedException {
        // Set up Http Storage
        createStorage(nakshaClient, "ViewUnion/setup/http_storage_space/create_storage.json");
        ...
        // Set up  View storage and View Space over Psql and Http Storage based spaces
        createStorage(nakshaClient, "ViewUnion/setup/view_space/create_storage.json");
