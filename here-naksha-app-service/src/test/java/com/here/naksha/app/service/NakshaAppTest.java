...
class NakshaAppTest {
  ...
  //
  //    // When:
  //    final HttpResponse<String> response = nakshaClient.put("hub/storages/um-mod-dev", updateStorageJson,
  // streamId);
  //
  //    // Then:
  ...
  // loadFileOrFail("TC0101_duplicateEventHandler/response_conflict.json");
  //    final String streamId = UUID.randomUUID().toString();
  //
  //    // 2. Perform REST API call creating handler
  //    final HttpResponse<String> response = nakshaClient.post("hub/handlers", bodyJson, streamId);
  ...
  // loadFileOrFail("TC0162_updateEventHandlerWithMismatchingId/response.json");
  //    final String streamId = UUID.randomUUID().toString();
  //
  //    // When:
  //    final HttpResponse<String> response =
  ...
  //    // 3. Perform assertions
  //    assertEquals(200, response.statusCode(), "ResCode mismatch");
  //    JSONAssert.assertEquals("Expecting space response", expectedBodyPart, response.body(),
  // JSONCompareMode.LENIENT);
  //    assertEquals(streamId, getHeader(response, HDR_STREAM_ID), "StreamId mismatch");
  //  }
  //
  ...
  //    // Test API : PUT /hub/spaces/{spaceId}
  //    // Given:
  //    final String bodyWithDifferentSpaceId =
  // loadFileOrFail("TC0263_updateSpaceWithMismatchingId/update_space.json");
  ...
  @Test
  @Order(16)
  void tc0900_testSearchFeatures() throws URISyntaxException, IOException, InterruptedException, JSONException {
    ...
    JSONAssert.assertEquals(
        "Expecting filtered features", expectedBodyPart, response.body(), JSONCompareMode.LENIENT);
  }

  @Test
  @Order(17)
  void tc0901_testSearchFeatures() throws URISyntaxException, IOException, InterruptedException, JSONException {
    ...
    // Then: Perform assertions
    Assertions.assertEquals(200, response.statusCode());
    JSONAssert.assertEquals("Expecting no features", expectedBodyPart, response.body(), JSONCompareMode.LENIENT);
  }
