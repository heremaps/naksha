...
public class ViewTypeUnionAllTest extends ApiTest {
    ...
    private static final String HTTP_SPACE_ID = "base_view_union_all_test_http_space";
    private static final String PSQL_SPACE_ID = "delta_view_union_all_test_psql_space";
    private static final String VIEW_SPACE_ID = "view_union_all_view_space";

    private static final String ENDPOINT = "/view_union_all/test/bbox";


    @BeforeAll
    static void setup() throws URISyntaxException, IOException, InterruptedException {
        // Set up Http Storage based Space
        setupSpaceAndRelatedResources(nakshaClient, "ViewUnionAll/setup/http_storage_space");
    ...
    @Test
    void testGetByBBoxOnViewSpaceUnionAll() throws Exception {
