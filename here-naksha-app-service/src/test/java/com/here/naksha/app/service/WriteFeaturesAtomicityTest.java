...
class WriteFeaturesAtomicityTest extends ApiTest {
  ...
  @Test
  void tc_1101_partialCreateShouldFail() throws URISyntaxException, IOException, InterruptedException {
    // Given: multiple features to save, some of which are invalid
    List<String> validFeatureIds = List.of("tc_1101_feature_1", "tc_1101_feature_2");
    String createFeaturesJson = loadFileOrFail("WriteFeaturesAtomicity/TC1101_partialCreateShouldFail/create_features.json");
  ...
  @Test
  void tc_1102_partialUpdateShouldFail() throws URISyntaxException, IOException, InterruptedException {
    ...
    HttpResponse<String> updateResp = nakshaClient.put("hub/spaces/" + SPACE_ID + "/features",
        loadFileOrFail("WriteFeaturesAtomicity/TC1102_partialUpdateShouldFail/update_features.json"),
        streamId);
