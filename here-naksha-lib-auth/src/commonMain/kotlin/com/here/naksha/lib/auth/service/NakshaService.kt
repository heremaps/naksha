...
class NakshaService : AccessRightsService() {
    ...
    fun createCollections(): CreateCollections = getOrCreate(CreateCollections.NAME, CreateCollections::class)
    fun readCollections(): ReadCollections = getOrCreate(ReadCollections.NAME, ReadCollections::class)
    fun updateCollections(): UpdateCollections = getOrCreate(UpdateCollections.NAME, UpdateCollections::class)
    fun deleteCollections(): DeleteCollections = getOrCreate(DeleteCollections.NAME, DeleteCollections::class)

    fun useEventHandlers(): UseEventHandlers = getOrCreate(UseEventHandlers.NAME, UseEventHandlers::class)
    fun manageEventHandlers(): ManageEventHandlers = getOrCreate(ManageEventHandlers.NAME, ManageEventHandlers::class)
