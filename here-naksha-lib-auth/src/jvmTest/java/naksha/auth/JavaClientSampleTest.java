...
import static naksha.base.Base.newList;
...
class JavaClientSampleTest {
  ...
  void armConstructionSample() {
    ...
    PTypedArray<ResourceAttributes> attributes = armService.getResourceAttributesForAction(ReadCollections.NAME);
    ...
    final PTypedArray<Object> tags =
        assertInstanceOf(PAnyArray.class, attributes.get(1).get(CollectionAttributes.TAGS_KEY));
