 ...
 * @param <T> The type, must extend [NakType].
 */
@JsExport
abstract class NakKlass<out T : NakType> : Klass<T>() {
    /**
     ...
     */
    open fun symbol(): PSymbol = Nak.NAK_SYM
     ...
     */
    open fun isAssignable(o: Any?): Boolean = getPlatformKlass().isInstance(Nak.unbox(o))
     ...
     */
    open fun assign(o: Any, vararg args: Any?): T = Nak.assign(o, this, args)
}