 ...
 * [namespace]. The implementation is only done in the class directly extending the [BaseEnum], which is called as well the **namespace**.
 *
...
@JsExport
abstract class BaseEnum : CharSequence {
    init {
    ...
    /**
     * The value, either [String], [Int], [Long], [Double], [Boolean] or `null`.
     */
    var value: Any? = null
        private set
    ...
    companion object JsEnumCompanion {
         ...
         */
        @JvmStatic
        private val klassToNamespace = AtomicMap<KClass<out BaseEnum>, KClass<out BaseEnum>>()

        /**
         * All defined enumeration values of a namespace. The first level is the namespace (the Kotlin class that directly extend [BaseEnum]), the second level maps values to defined enumeration instances.
         */
        @JvmStatic
        private val definedMap = AtomicMap<KClass<*>, AtomicMap<Any, BaseEnum>>()

        /**
         * All defined enumeration aliases. The first level is the namespace (the Kotlin class that directly extend [BaseEnum]), the second level maps alias values to defined enumeration instances.
         */
        @JvmStatic
        private val definedAliasesMap = AtomicMap<KClass<*>, AtomicMap<Any, BaseEnum>>()

        /**
         * All temporary registered enumeration values and alias values of a namespace. The first level is the namespace (the Kotlin class that directly extend [BaseEnum]), the second level maps main values to temporary registered instances.
         */
        @JvmStatic
        private val temporaryMap = AtomicMap<KClass<*>, AtomicMap<Any, WeakRef<BaseEnum>>>()
         ...
         */
        @JvmStatic
        private fun defMap(ns: KClass<out BaseEnum>): AtomicMap<Any, BaseEnum> {
         ...
         */
        @JvmStatic
        private fun aliasMap(ns: KClass<out BaseEnum>): AtomicMap<Any, BaseEnum> {
         ...
         */
        @JvmStatic
        private fun tempMap(ns: KClass<out BaseEnum>, create: Boolean): AtomicMap<Any, WeakRef<BaseEnum>>? {
        ...
        @JvmStatic
        @JsStatic
        fun <ENUM : BaseEnum> defIgnoreCase(enumKlass: KClass<ENUM>, value: String, init: Fx1<ENUM>? = null): ENUM {
        ...
        @JvmStatic
        @JsStatic
        fun <ENUM : BaseEnum> def(enumKlass: KClass<ENUM>, value: Any?, init: Fx1<ENUM>? = null): ENUM {
        ...
        @JvmStatic
        @JsStatic
        fun <ENUM : BaseEnum> get(value: Any?, enumKlass: KClass<out ENUM>): ENUM = __get(value, enumKlass, true)

        /**
         * Returns an iterator above all defined enumeration value.
         * @param ns the namespace as returned by [BaseEnum.namespace], which is simply the base enumeration class.
         * @return an iterator above all defined enumeration values.
         */
        @JvmStatic
        @JsStatic
        fun <ENUM : BaseEnum> iterate(ns: KClass<out ENUM>): Iterator<ENUM> {
        ...
        @Suppress("UNCHECKED_CAST")
        @JvmStatic
        fun <ENUM : BaseEnum> getDefined(value: Any?, enumKlass: KClass<out ENUM>): ENUM? {
        ...
        @Suppress("UNCHECKED_CAST")
        @JvmStatic
        private fun <ENUM : BaseEnum> __get(value: Any?, enumKlass: KClass<out ENUM>, temporary: Boolean): ENUM {
            ...
            while (true) {
                ...
                if (ns == null) {
                    ...
                    val instance = Base.allocateInstance(enumKlass)
                ...
                if (e == null) {
                    ...
                    e = Base.allocateInstance(enumKlass)
     ...
     * directly extends [BaseEnum]. Should simply be implemented as:
     * ```
     * val namespace: KClass<out JsEnum> = this::class
     * ```
     * @return The namespace, the Kotlin class that directly extends [BaseEnum].
     */
    abstract fun namespace(): KClass<out BaseEnum>

    /**
     * Register an enumeration child-class.
     * @param enumKlass the enumeration child-class.
     */
    protected fun <CHILD : BaseEnum> register(enumKlass: KClass<out CHILD>) {
        ...
        if (existing == null) Base.initializeKClass(enumKlass)
    }


    /**
     * This method is invoked exactly ones per namespace, when the enumeration namespace is not yet initialized. It simplifies
     * auto-initialization. Actually, it is required that the namespace class (the class directly extending the [BaseEnum]) implements this
     ...
     */
    @Suppress("UNCHECKED_CAST")
    fun <SELF : BaseEnum> with(lambda: Fx1<SELF>): SELF {
     ...
     */
    @Suppress("UNCHECKED_CAST")
    protected fun <SELF : BaseEnum> alias(value: Any): SELF {
        // Optimistic locking
        while (true) {
            val ns = namespace()
...
//                }
    ...
    private var _literal: Literal? = null

    /**
     * The enumeration [value] converted to [Literal], the same value as returned by [toString], just as [Literal].
     */
    val literal: Literal
        get() {
            var literal = _literal
            if (literal == null) {
                literal = Literal.of(createString())
                _literal = literal
            }
            return literal
        }
    ...
    fun like(other: Any?): Boolean {
        ...
        if (other is BaseEnum) return other.value == value
        return value == other
    }

    final override fun equals(other: Any?): Boolean = this === other || (other is BaseEnum && other.value == value)
