...
interface IBaseLogger {
    ...
    /**
     * Writes a debug log.
     * @param msgFn A function that is invoked if logging is enabled, and that should return either the final message to log or _null_ to suppress logging for some other reason.
     */
