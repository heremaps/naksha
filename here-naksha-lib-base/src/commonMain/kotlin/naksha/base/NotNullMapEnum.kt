...
/**
 * The description of an enumeration property stored in a map.
 *
 ...
 *     @JvmStatic
 *     @JsStatic
 *     val TEST = def(forKClass(FooEnum::class), "test")
 *   }
 *   override val namespace = forKClass(FooEnum::class)
 *   override fun initClass() {}
 * }
 * class Foo : MapProxy<String, Any>(STRING, STRING) {
 *   companion object {
