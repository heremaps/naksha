...
expect class Symbols {
    companion object SymbolsCompanion {
       /**
         ...
         */
        fun get(obj: PlatformObject, symbol: Symbol): Any?
         ...
         */
        fun set(obj: PlatformObject, symbol: Symbol, value: Any?): Any?
         ...
         */
        fun has(obj: PlatformObject, symbol: Symbol): Boolean
         ...
         */
        fun remove(obj: PlatformObject, symbol: Symbol): Any?
