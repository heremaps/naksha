...
open class Version(@JvmField val number: Long) : Comparable<Version> {
    ...
    companion object VersionCompanion {
        ...
        private val SEQ_30_MASK = 0x3FFF_FFFF

        /** Mask for the 41-bit manual-version seq field (upper 21 bits of the 64-bit value must be 0). */
        private val MANUAL_SEQ_MASK = 0x1FF_FFFF_FFFF // 41 bits; 2,199,023,255,551
        ...
        /**
         * A range for sequence numbers.
         * @since 3.0
         */
        @JvmStatic
        @JsStatic
        val seqRange = IntRange(0, 1073741824)
        ...
        @JsStatic
        @JvmOverloads
        fun now(seq: Long = seqRange.random().toLong(), action: Action = Action.CREATE): Version {
        ...
        @JvmField
        @JsStatic
        val MIN_AUTO = auto(16, 1, 1, 0L, Action.CREATE)
        ...
        @JvmField
        @JsStatic
        val MAX_AUTO = auto(4095, 12, 31, 1_073_741_823L, Action.VERSION)
        ...
        @JvmField
        @JsStatic
        val MIN_MANUAL = manual(1L, Action.CREATE)
        ...
        @JvmField
        @JsStatic
        val SEQ_MAX: Long = SEQ_30_MASK.toLong()
         ...
         * @since 3.0
         */
        const val SEQ_INC: Long = 1L shl 2
    }
