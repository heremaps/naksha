...
actual abstract class BaseNumber : Number(), IBase {
    companion object BaseNumber_C {
    ...
    actual override fun withAtomic(enable: Boolean): BaseNumber {
        this.atomic = enable
        return this
    }
    ...
    actual override fun withReadOnly(enable: Boolean): BaseNumber {
    ...
    actual override fun withImmutable(enable: Boolean): BaseNumber {
