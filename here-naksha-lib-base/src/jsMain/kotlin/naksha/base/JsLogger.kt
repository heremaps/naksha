...
internal class JsLogger : IBaseLogger {
    ...
    override fun debug(msg: String, vararg args: Any?) {
        if (!BaseUtil.ENABLE_DEBUG) return
    ...
    override fun info(msg: String, vararg args: Any?) {
        if (!BaseUtil.ENABLE_INFO) return
        val m = if (args == null || args.size == 0) msg else toString(msg, *args)
    ...
    override fun warn(msg: String, vararg args: Any?) {
        if (!BaseUtil.ENABLE_WARN) return
        val m = if (args == null || args.size == 0) msg else toString(msg, *args)
    ...
    override fun error(msg: String, vararg args: Any?) {
        if (!BaseUtil.ENABLE_ERROR) return
        val m = if (args == null || args.size == 0) msg else toString(msg, *args)
