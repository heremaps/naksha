...
/**
 * An object that can provide proxies for {@link JsonMap}.
 * @since 3.0
 * @see JsonArray
 ...
 * @see JsonMapProxy
 */
public interface JsonMapProxiable {
   ...
   * @since 3.0
   */
  default <T, P extends JsonMapProxy<T>> @NotNull P proxy(@NotNull Class<P> as) {
   ...
   * @since 3.0
   */
  <T, P extends JsonMapProxy<T>> @NotNull P proxy(@NotNull Class<P> as, boolean exact);
}
