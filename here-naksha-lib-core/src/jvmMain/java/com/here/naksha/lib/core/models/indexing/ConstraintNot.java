...
public class ConstraintNot extends Constraint {
  public static final PlatformType<ConstraintNot> TYPE = forClass(ConstraintNot.class);
  private static final NullableProperty<ConstraintNot, ConstraintList> OF
  ...
  public void setOf(@Nullable List<? extends Constraint> of) {
