...
public class WebMercatorTileTest {
  ...
  public void testBBoxCacheReuse() {
    ...
    final SpBoundingBox bbox = webMercatorTile.getBBox(false);
    final SpBoundingBox reusedBBox = webMercatorTile.getExtendedBBox(0);
    ...
    final int margin = 20;
    final SpBoundingBox extendedBBox = webMercatorTile.getExtendedBBox(margin);
    final SpBoundingBox reusedExtendedBBox = webMercatorTile.getExtendedBBox(20);
