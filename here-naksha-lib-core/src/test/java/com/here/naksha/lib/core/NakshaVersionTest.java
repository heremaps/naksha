...
class NakshaVersionTest {
  ...
  void testBasics() {
    ...
    v = new NakshaVersion(1, 2, 3, NakshaVersion.PreReleaseTag.none, 0);
    ...
    assertEquals(v.getPreReleaseVersion(), fromLong.getPreReleaseVersion());
  }
  ...
  void testPreRelease() {
    ...
    assertEquals(v.getMinor(), fromLong.getMinor());
    assertEquals(v.getRevision(), fromLong.getRevision());
//    TODO(lib-core test) pre release tag and version not reflected from long
//    assertEquals(v.getPreReleaseTag(), fromLong.getPreReleaseTag());
//    assertEquals(v.getPreReleaseVersion(), fromLong.getPreReleaseVersion());
  }
