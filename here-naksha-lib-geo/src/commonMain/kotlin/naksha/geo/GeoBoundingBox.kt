...
@JsExport
class GeoBoundingBox() : ListProxy<Double>(Double_TYPE) {

    @JsName("fromWestSouthEastNorth")
    constructor(west: Double, south: Double, east: Double, north: Double) : this() {
        addAll(arrayOf(west, south, east, north))
    }

    @JsName("fromWestSouthAltEastNorthAlt")
    ...
    fun setToPoint(longitude: Double, latitude: Double, margin: Double = 0.0): GeoBoundingBox {
    ...
    fun addPoint(pointCoord: PointCoord): GeoBoundingBox {
    ...
    fun addMultiPoint(multiPoint: MultiPointCoord): GeoBoundingBox {
    ...
    fun addLineString(lineString: LineStringCoord): GeoBoundingBox {
    ...
    fun addMultiLineString(multiLineString: MultiLineStringCoord): GeoBoundingBox {
    ...
    fun addPolygon(polygon: PolygonCoord): GeoBoundingBox {
    ...
    fun addMultiPolygon(multiPolygon: MultiPolygonCoord): GeoBoundingBox {
    ...
    fun addMargin(margin: Double): GeoBoundingBox {
        return this
    ...
    fun withMinLongitude(longitude: Double): GeoBoundingBox {
        set(minLonIndex(), longitude)
        return this
    }
    fun withWestLongitude(longitude: Double): GeoBoundingBox = withMinLongitude(longitude)
    fun withMinLatitude(latitude: Double): GeoBoundingBox {
        set(minLatIndex(), latitude)
        return this
    }
    fun withSouthLatitude(latitude: Double): GeoBoundingBox = withMinLatitude(latitude)
    fun withMinAltitude(altitude: Double): GeoBoundingBox {
        to3D()
        set(minAltIndex()!!, altitude)
        return this
    }
    fun withSouthWestAltitude(altitude: Double): GeoBoundingBox = withMinAltitude(altitude)

    fun withMaxLongitude(longitude: Double): GeoBoundingBox {
        set(maxLonIndex(), longitude)
        return this
    }
    fun withEastLongitude(longitude: Double): GeoBoundingBox = withMaxLongitude(longitude)
    fun withMaxLatitude(latitude: Double): GeoBoundingBox {
        set(maxLatIndex(), latitude)
        return this
    }
    fun withNorthLatitude(latitude: Double): GeoBoundingBox = withMaxLatitude(latitude)
    fun withMaxAltitude(altitude: Double): GeoBoundingBox {
        to3D()
        set(maxAltIndex()!!, altitude)
        return this
    }
    fun withNorthEastAltitude(altitude: Double): GeoBoundingBox = withMaxAltitude(altitude)
