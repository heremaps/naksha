...
class AdminBasedSpaceStorageReader implements IReadSession {

  final EventPipelineFactory eventPipelineFactory;
  ...
  public AdminBasedSpaceStorageReader(
  ...
  private @NotNull Result executeReadCollections(final @NotNull ReadCollections rc) {
    try (final IReadSession admin = adminStorage.newReadSession(context, useMaster)) {
