...
data class Metadata(
     ...
     *
     * If _null_, then it is the default type of the collection, see [naksha.model.objects.NakshaCollection.defaultFeatureType].
     */
    @JvmField
    val type: String?,
    ...
    companion object Metadata_C {
         ...
         * @param geometry the GeoJSON geometry of the feature.
         * @return the geo-grid value.
         */
        fun geoGrid(featureId: String, geometry: SpGeometry?): Int {
            val c = geometry?.calculateCentroid()
            return if (c != null) HereTile(c.latitude, c.longitude).intKey else Fnv1a32.string(0, featureId)
        }
    }
}