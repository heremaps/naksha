...
class NakshaVersion(
    ...
    companion object {
        ...
        // beta.9, 10, and 11 were never committed, but can be dangling in caches!
        const val v3_0_0_beta_12 = "3.0.0-beta.12"

        /**
         * The current version as string to constant usage cases.
         * @since 3.0
         */
        const val CURRENT = v3_0_0_beta_12
    ...
    enum class PreReleaseTag(val enc: Int) {
        /**
         * Stable final release, not `alpha` or `beta`, API should be stable within revisions.
         * @since 3.0
         */
        none(FINAL_PRE_RELEASE_ENC),
        /**
         * Experimental early pre-release, API is subject to change.
         * @since 3.0
         */
        alpha(0),

        /**
         * Experimental more stable pre-release, API is subject to change.
         * @since 3.0
         */
        beta(1);
