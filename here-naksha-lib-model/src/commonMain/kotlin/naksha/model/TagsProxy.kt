...
class TagsProxy() : ListProxy<String>(String::class) {
     ...
     * @return this.
     */
    fun removeTags(tags: List<String>?, normalize: Boolean): TagsProxy {
     ...
     * @return this.
     */
    fun removeTagsWithPrefix(prefix: String?): TagsProxy {
     ...
     * @return this.
     */
    fun removeTagsWithPrefixes(prefixes: List<String?>?): TagsProxy {
        if (prefixes != null) {
     ...
     * @return this.
     */
    fun addTags(tags: List<String>?, normalize: Boolean): TagsProxy {
        if (!tags.isNullOrEmpty()) {
            if (normalize) {
                for (s in tags) {
     ...
     * @return this.
     */
    fun addAndNormalizeTags(vararg tags: String): TagsProxy {
        if (tags.isNotEmpty()) {
            for (s in tags) {
                val tag: String = normalizeTag(s)
                if (!contains(tag)) {
