...
class Int64Member() : TypedMember<Int64Member>() {
    ...
    fun get(feature: NakshaFeature): Int64? = readInt64(feature)
     ...
     */
    @JsName("getFromTuple")
    fun get(tuple: Tuple): Int64? = readInt64(tuple)

    /** Sets the int64 value of this member on the given object. */
    fun set(feature: PTypedMap<*, *>, value: Int64?): Any? = if (value == null) feature.setPath(UNDEFINED, path) else feature.setPath(value, path)
}
