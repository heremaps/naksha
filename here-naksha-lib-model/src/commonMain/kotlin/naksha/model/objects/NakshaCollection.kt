...
open class NakshaCollection() : NakshaFeature() {
     ...
     *
     * Each [Index] declares a name, an [IndexType] ([IndexType.BTREE] / [IndexType.SPATIAL] / [IndexType.SET] / [IndexType.TAGS]), the column(s) to index, an optional include-list (for [IndexType.BTREE]), and a `unique` flag.
     *
