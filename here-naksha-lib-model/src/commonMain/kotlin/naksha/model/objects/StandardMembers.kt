...
class StandardMembers private constructor() {
    ...
    companion object StandardMembers_C {
         ...
         */
        @JvmField @JsStatic
        val NextVersion = Member("_nv", MemberType.INT64, JsonPath("nv")).withMandatory()
         ...
         */
        @JvmField @JsStatic
        val GlobalBookFeatureNumber = Member("_global_book_fn", MemberType.INT64, JsonPath("gbfn")).withMandatory()
         ...
         */
        @JvmField @JsStatic
        val Id = Member("_id", MemberType.STRING, JsonPath("id")).withMandatory()
         ...
         */
        @JvmField @JsStatic
        val Feature = Member("_feature", MemberType.BYTE_ARRAY, JsonPath()).withMandatory()
