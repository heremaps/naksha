...
class StandardMembers private constructor() {
    ...
    companion object StandardMembers_C {
        ...
        /**
         * `can` — **Catalog-number** (`INT32`). The map-level numeric identifier. Mandatory,
         ...
         */
        @JvmField @JsStatic
        val CatalogNumber = Member("can", MemberType.INT32)

        /**
         * `con` — **Collection-number** (`INT32`). The collection-level numeric identifier. Mandatory,
         * storage-managed. Not materialised as a physical column in all implementations
         * (e.g. `lib-psql` treats it as implicit context).
         * @since 3.0
         */
        @JvmField @JsStatic
        val CollectionNumber = Member("con", MemberType.INT32)
        ...
        val MANDATORY: List<Member> = listOf(
            ...
            Version, NextVersion, Feature, GlobalBookNumber
        )
        ...
        /**
         * `id` — feature string identifier. Present only for named features (where the feature-number
         * is derived from a hash of the id string). Numeric features use [FeatureNumber] as their id.
         * Default member.
         * @since 3.0
         */
        @JvmField @JsStatic
        ...
        val DEFAULT: List<Member> = listOf(
            ...
            BaseTupleNumber,
            Id, AppId, Author, Origin, Target, FeatureType,
