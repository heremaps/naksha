...
interface IResultSet {
    ...
    /**
     * Returns all [tuples][Tuple] being part of the result-set, the tuples may not have been read from the storage yet, and may require to invoke [ISession.fetchTuples]. Only the tuples till [validationEnd] are validated (filtered), all others are in an unknown state, except [fetchAll].
     *
