...
open class RowField() : AnyObject() {
    ...
    companion object RowField_C {
        ...
        /**
         * The reference to the [transaction number][naksha.model.Metadata.txn].
         *
        ...
        /**
         * The reference to the [previous transaction number][naksha.model.Metadata.ptxn].
         *
