...
open class MetaColumn() : AnyObject() {
    ...
    companion object TupleColumn_C {
        ...
        /**
         * The name of the virtual column that stores the [base tuple-number][naksha.model.Metadata.baseTupleNumber], encoded as [128-bit variant][naksha.model.TupleNumberVariant.B128], as generated by [TupleNumber.toByteArray][naksha.model.TupleNumber.toByteArray].
         *
         ...
         * - [AnyOp.IS_NOT_NULL]
         * - [AnyOp.IS_ANY_OF]
         * @see [naksha.model.TupleNumberVariant.B128]
         */
        const val BASE_TUPLE_NUMBER = "base_tn"

        /**
         * Returns a new meta-column for [BASE_TUPLE_NUMBER].
         * @return a new meta-column.
         */
        @JvmStatic
        @JsStatic
