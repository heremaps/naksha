...
open class MetaColumn() : AnyObject() {
    ...
    companion object TupleColumn_C {
        ...
        /**
         * The name of the virtual column that stores the [tuple-number][naksha.model.Metadata.tupleNumber], encoded as 160-bit variant, as generated by [TupleNumber.toByteArray][naksha.model.TupleNumber.toByteArray].
         *
