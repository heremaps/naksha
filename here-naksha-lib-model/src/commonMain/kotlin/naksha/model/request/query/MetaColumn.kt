...
open class MetaColumn() : AnyObject() {
    ...
    companion object TupleColumn_C {
        ...
        /**
         * The name of the virtual column that stores the [base tuple-number][naksha.model.Metadata.baseTupleNumber], encoded as [96-bit variant][[naksha.model.TupleNumberVariant.B96]], as generated by [TupleNumber.toByteArray][naksha.model.TupleNumber.toByteArray].
         *
