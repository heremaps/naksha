 ...
 */
@JsExport
actual interface ISession : IDictReader, AutoCloseable {

    /**
     * The storage to which the session is bound.
     * @since 3.0.0
     */
    actual val storage: IStorage
     ...
     * @since 3.0.0
     */
    actual fun getMapById(mapId: String): NakshaMap?
     ...
     * @since 3.0.0
     */
    actual fun getMapByNumber(mapNumber: Int): NakshaMap?
     ...
     * @since 3.0.0
     */
    actual fun getCollectionById(map: NakshaMap, collectionId: String): NakshaCollection?
     ...
     * @since 3.0.0
     */
    actual fun fetchTuples(featureTuples: List<FeatureTuple?>, from: Int, to: Int, fetchFromHistory: Boolean, mode: FetchMode)
     ...
     * @since 3.0.0
     */
    actual fun getCollectionByNumber(map: NakshaMap, collectionNumber: Int): NakshaCollection?
     ...
     * @since 3.0.0
     */
    actual fun refreshCollections(map: NakshaMap)
     ...
     * @since 3.0.0
     */
    actual fun getEncodingFlags(feature: Any?, context: Any?): Flags

    override actual fun getDictionary(id: String): JbDictionary?
    override actual fun getEncodingDictionary(feature: Any?, context: Any?): JbDictionary?
}