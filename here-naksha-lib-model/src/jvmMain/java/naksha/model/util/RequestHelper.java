...
public class RequestHelper {
  ...
  public static @NotNull WriteRequest deleteFeaturesByIdsRequest(
    ...
    final WriteRequest request = new WriteRequest();
    for (String id : ids) {
      request.add(new Write().deleteFeatureById(collection, id, null));
    }
    return request;
  }
  ...
  public static @NotNull WriteRequest deleteFeatureByIdRequest(
      final @NotNull NakshaCollection collection, final @NotNull String id) {
    final Write write = new Write().deleteFeatureById(collection, id, null);
    return new WriteRequest().add(write);
  }
