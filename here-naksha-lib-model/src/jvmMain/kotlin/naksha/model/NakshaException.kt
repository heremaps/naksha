...
actual open class NakshaException actual constructor(@JvmField actual val error: NakshaError) :
    ...
    actual constructor(
        ...
        id: String?,
        cause: Throwable?
    ) : this(NakshaError(code, msg, cause, id))

    constructor(code: String, msg: String) : this(NakshaError(code, msg))
}