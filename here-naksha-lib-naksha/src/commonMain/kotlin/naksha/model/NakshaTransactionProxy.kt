...
class NakshaTransactionProxy : NakshaFeatureProxy() {
     ...
     */
    var  featuresModified: Int by NakshaTransactionProxy.Companion.FEATURES_MODIFIED

    /**
     * Total number of bytes sent to DB in transaction.
     */
    var featuresBytes: Int by NakshaTransactionProxy.Companion.FEATURES_BYTES
     ...
     */
    var seqNumber: Int64 by NakshaTransactionProxy.Companion.SEQ_NUMBER

    var seqTs: Int64 by NakshaTransactionProxy.Companion.SEQ_TS

    var collections: TransactionCollectionInfoProxy by NakshaTransactionProxy.Companion.COLLECTIONS
