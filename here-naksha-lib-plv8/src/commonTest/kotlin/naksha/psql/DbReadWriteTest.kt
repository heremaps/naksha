...
//        val geometry = PointGeometry(5.0, 6.0, 2.0)
...
//    fun readWithBuffer() {
//
//        val xyzPoint = PointGeometry(4.0, 5.0)
//
//        val readFeatures = ReadFeatures(
//            collectionIds = arrayOf(collectionId),
...
//        val xyzGeometry = PointGeometry(5.0, 6.0, 2.0)
...
//        // different geometry
//        val newPoint1 = PointGeometry(5.1, 6.0, 2.1)
//        val newPoint2 = PointGeometry(5.15, 6.0, 2.15)
//        val lineString = LineStringGeometry(newPoint1, newPoint2)
//
...
//        val geometry = feature.geometry
//        assertNotNull(geometry)
//        val expectedGeometry = PointGeometry(5.15, 6.0, 2.15)
...
//        // given
//        val feature = NakshaFeatureProxy(SINGLE_FEATURE_ID)
//        feature.geometry = PointGeometry(0.0, 0.0, 0.0)
