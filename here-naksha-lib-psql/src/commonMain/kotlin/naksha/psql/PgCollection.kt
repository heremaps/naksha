...
open class PgCollection internal constructor(
     ...
     * @since 3.0.0
     */
    @JvmField val map: PgMap,

    /**
     * The HEAD state of the collection.
     * @since 3.0.0
     */
    @JvmField val nakshaCollection: NakshaCollection,

    /**
     * The map-id.
     * @since 3.0.0
     */
    @JvmField val id: String = nakshaCollection.id,

    /**
     * The map-number.
     * @since 3.0.0
     */
    @JvmField val number: Int = nakshaCollection.number ?: throw NakshaException(ILLEGAL_ARGUMENT, "The given naksha-collection must have a valid number")
) {
    /**
