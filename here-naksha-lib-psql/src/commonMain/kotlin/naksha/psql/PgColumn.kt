...
class PgColumn : JsEnum() {
    ...
    companion object PgColumn_C {
        /**
         * The [PlatformType] of [PgColumn].
         * @since 3.0
         */
        @JvmField
        @JsStatic
        val TYPE = forKClass(PgColumn::class).withPackageName(PACKAGE_NAME)
        ...
        @JvmStatic
        @JsStatic
        fun of(columnName: String): PgColumn = get(columnName, TYPE)
        ...
        @JvmField
        @JsStatic
        val updated_at = def(TYPE, "updated_at") { self ->
            self._i = 0
        ...
        @JvmField
        @JsStatic
        val created_at = def(TYPE, "created_at") { self ->
            self._i = 1
            self._type = PgType.INT64
        }
        ...
        @JvmField
        @JsStatic
        val author_ts = def(TYPE, "author_ts") { self ->
            self._i = 2
            self._type = PgType.INT64
        }
        ...
        @JvmField
        @JsStatic
        val here_tile = def(TYPE, "here_tile") { self ->
            self._i = 8
            self._type = PgType.INT
            self._extra = "NOT NULL"
        }
        ...
        @JvmField
        @JsStatic
        val next_tn = def(TYPE, "next_tn") { self ->
            self._i = 12
            self._type = PgType.BYTE_ARRAY
        ...
        @JvmField
        @JsStatic
        val prev_tn = def(TYPE, "prev_tn") { self ->
            self._i = 13
            self._type = PgType.BYTE_ARRAY
            self._extra = "STORAGE $PLAIN" // prevents either compression or out-of-line storage
        }
        ...
        @JvmField
        @JsStatic
        val base_tn = def(TYPE, "base_tn") { self ->
            self._i = 14
            self._type = PgType.BYTE_ARRAY
            self._extra = "STORAGE $PLAIN" // prevents either compression or out-of-line storage
        }
        ...
        @JvmField
        @JsStatic
        val app_id = def(TYPE, "app_id") { self ->
            self._i = 16
            self._type = PgType.STRING
        ...
        @JvmField
        @JsStatic
        val author = def(TYPE, "author") { self ->
            self._i = 17
            self._type = PgType.STRING
            self._extra = "STORAGE $PLAIN COLLATE \"C\""
        }
        ...
        @JvmField
        @JsStatic
        val origin = def(TYPE, "origin") { self ->
            self._i = 18
            self._type = PgType.STRING
        ...
        @JvmField
        @JsStatic
        val target = def(TYPE, "target") { self ->
            self._i = 19
            self._type = PgType.STRING
            self._extra = "STORAGE $PLAIN COLLATE \"C\"" // prevents either compression or out-of-line storage
        }
        ...
        @JvmField
        @JsStatic
        val ref_point = def(TYPE, "ref_point") { self ->
            self._i = 26
            self._type = PgType.BYTE_ARRAY
            self._extra = "STORAGE $MAIN"
        }
        ...
        @JvmField
        @JsStatic
        val feature = def(TYPE, "feature") { self ->
            self._i = 28
            self._type = PgType.BYTE_ARRAY
            self._extra = "STORAGE $MAIN"
        }
        ...
        @JvmField
        @JsStatic
        val attachment = def(TYPE, "attachment") { self ->
            self._i = 29
            self._type = PgType.BYTE_ARRAY
            self._extra = "STORAGE $MAIN"
        }
