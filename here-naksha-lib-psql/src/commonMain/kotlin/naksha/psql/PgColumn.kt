...
class PgColumn : JsEnum() {
    ...
    companion object PgColumnCompanion {
        ...
        private val autoGeneratedColumns = listOf(tuple_number)

        /**
         * All possible columns to be used in INSERT statement.
         */
        @JvmField
        @JsStatic
        val allWritableColumns = allColumns.filter { !autoGeneratedColumns.contains(it) }
