 ...
 * @since 3.0
 */
enum class TestCatalog(val id: String) {
    ...
    companion object {
        /**
         * Returns the [TestCatalog] whose [id] matches [schemaName], or `null` if none matches.
         */
        fun byId(schemaName: String): TestCatalog? = entries.firstOrNull { it.id == schemaName }
    }
}
