...
import static com.here.naksha.lib.core.models.geojson.implementation.namespaces.XyzNamespace.CREATED_AT;
import static com.here.naksha.lib.core.models.geojson.implementation.namespaces.XyzNamespace.PUUID;
import static com.here.naksha.lib.core.models.geojson.implementation.namespaces.XyzNamespace.UPDATED_AT;
...
public abstract class WriteCollectionTest {
    ...
    void errorOnNewWithUuid() {
        ...
        String detailed = "The feature with id .* cannot be created. Property UUID should not be provided as input.";
        responseUuid.then().assertThat().statusCode(greaterThanOrEqualTo(400))
                .and().body("type", equalTo("ErrorResponse"))
                .and().body("errorMessage", matchesRegex(expectedWriteErrorMessage(detailed)));
        assertDbEmpty();
    }
    ...
    void errorOnUpdateWithNonMatchingUuid() {
        ...
        responseUpdated.then()
                ...
                .and().body("errorMessage", equalTo(expectedWriteErrorMessage(detailed)));
    }
